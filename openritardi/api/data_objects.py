...
class Stop(Station):
        ...
        def __init__(self, name, id, name_short=None, lat=None, lon=None, id_region=None, arrival_time=None, departure_time=None, delay_arrival=None, delay_departure=None):
            '''_summary_
